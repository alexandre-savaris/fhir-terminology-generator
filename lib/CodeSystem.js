...
import Ajv from 'ajv';
// ???
import fhirSchema from '../schemas/R5/fhir.schema.json' assert { type: 'json' };
...
const handler = async function (argv) {
    ...
    // As recommended in the link below, $schema was removed from the fhir.schema.json.
    // Also, {1,9}} was replaced by {1,9} in the same file.
    // https://ajv.js.org/guide/schema-language.html

    // console.log(fhirSchema);
    // console.log(JSON.parse(filledTemplate));
